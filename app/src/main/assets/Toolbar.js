export default {
  template: `
    <div class="my-2">
    <button class="text-blue-500 text-xl border border-blue-500 px-1" v-if="!editing" @click="handleEdit">
      新增
    </button>
    <form ref="form" class="mt-4" v-if="editing" @submit.prevent="handleSubmit">
      ...
      <div class="mt-2 text-xl">
        <button class="text-blue-500 border border-blue-500 px-1" @click="handleCancel">
          取消
        </button>
        <button type="submit" class="text-blue-500 border border-blue-500 px-1">
          保存
        </button>
      </div>
    </form>
